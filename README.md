...
This is a self-hosted explorer for the Bitcoin II blockchain, driven by RPC calls to your own [Bitcoin II](https://github.com/jomagalo/bitcoin) node. It is easy to run and can be connected to other tools (like Electrum servers) to achieve a full-featured explorer.
